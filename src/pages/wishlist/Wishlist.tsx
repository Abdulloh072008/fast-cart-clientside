    ...
    if (wishlistItems.length === 0) {
        return (
            <div className="min-h-[60vh] flex items-center justify-center">
                <h2 className="text-xl font-medium tracking-wide">Your Wishlist is empty</h2>
            </div>
        );
    }
            ...
            <div className="max-w-6xl mx-auto px-4 py-16">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-6">
                    {Array.from({ length: 4 }).map((_, i) => (
                        <Card key={i} className="w-full sm:w-[calc(33%-12px)] lg:w-[calc(25%-18px)]">
                ...
                <div className="max-w-6xl mx-auto px-4 py-16">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap gap-6">
                        {randomProducts.map((product) => (
                            <div key={product.id} className="w-full sm:w-[calc(33%-12px)] lg:w-[calc(25%-18px)]">
